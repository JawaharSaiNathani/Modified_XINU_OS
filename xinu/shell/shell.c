...
const	struct	cmdent	cmdtab[] = {
	...
	{"cd",		FALSE,	xsh_changedir},
	{"ls",		FALSE,	xsh_listdir},
	{"pwd",		FALSE,	xsh_pathfinder},
	{"mkdir",	FALSE,	xsh_mkdir},
	{"create",	FALSE,	xsh_createfile}
	...
	)				/*   to accept commands		*/
{
	...
	while (TRUE) {
		...
		/* Display prompt */
		char temp_dirname[25];
		strcpy(temp_dirname,currdir->name);
		strncat(temp_dirname," $ ",3);
		fprintf(dev,temp_dirname);
